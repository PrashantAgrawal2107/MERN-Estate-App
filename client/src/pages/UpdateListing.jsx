    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                <input type='text' placeholder='Name' onChange={handleChange} value={formData.name} required 
                className='border p-3 rounded-lg' id='name' maxLength='62' minLength='10' />
                <textarea type='text' placeholder='Description' onChange={handleChange} value={formData.description} required 
                className='border p-3 rounded-lg' id='description' />
                <input type='text' placeholder='Address' onChange={handleChange} value={formData.address} required 
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    <div className='flex items-center gap-2'>
                            <input type='number' id='regularPrice' min='50' max='1000000'  onChange={handleChange} value={formData.regularPrice}  required 
                    ...
                    {formData.offer && 
                        <div className='flex items-center gap-2'>
                                <input type='number' id='discountedPrice' min='0' max='10000000'  onChange={handleChange} value={formData.discountedPrice}  required 
                                className='p-3 border border-gray-300 rounded-lg' />
                                <div className='flex flex-col items-center'>
